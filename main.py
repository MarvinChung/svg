...
action_encoder = MLP(FixedCovariance=False)
action_decoder = MLP(FixedCovariance=True)
...
action_encoder_optimizer = opt.optimizer(action_encoder.parameters(), lr=opt.lr, betas=(opt.beta1, 0.999))
action_decoder_optimizer = opt.optimizer(action_decoder.parameters(), lr=opt.lr, betas=(opt.beta1, 0.999))
